...
rh = window.rh;
model = rh.model;
var defaultTopic = "TankVisor_Help.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("TankVisor_Help.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '6a845df6-6027-48b0-a97f-0e9dad1523be' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "TankVisor Help");
